"""
FTSE LONG + SHORT Strategy Optimizer
...
# Configuration
DATA_DIR = Path("data/ftse_monthly")
RESULTS_DIR = Path("results/ftse_long_short")
TIMEZONE = pytz.timezone("Europe/London")

# UK Session Configuration
SESSION_START = time(8, 0)    # 08:00 GMT/BST
SESSION_END = time(16, 30)    # 16:30 GMT/BST (FTSE closes earlier than DAX!)
...
def is_in_session(timestamp):
    """Check if timestamp is within UK trading session (08:00-16:30 GMT/BST)."""
...
def main():
    ...
    # Load data
    csv_files = sorted(DATA_DIR.glob("ftse_*.csv"))
